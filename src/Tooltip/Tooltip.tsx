...
export const Tooltip: FC<TooltipProps> = ({
  ...
  return (
    ...
    >
      <span
        className={twMerge(
          "pointer-events-none max-w-[250px] break-words w-max absolute rounded opacity-0 bg-gray-700 p-2 text-sm text-white transition-opacity group-hover:opacity-100"
        )}
        ref={ref}
